...
FlagGood = (x != "?") & (x != " ")
# => array([ True,  True, False,  True,  True,  True,  True,  True, False, True,  True,  True], dtype=bool)

# Find elements that are numbers (More elegant solution, doesn't hardcode wrong entries)
